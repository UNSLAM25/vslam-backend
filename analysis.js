console.log("vslam backend, analysis.js");
...
var inputImage, inputCanvas, inputImageContext, outputCanvas, outputImageContext,
    duration, resolution, sendButton, myCheckbox;
...
window.onload = e => {
    ...
    inputImageContext = inputCanvas.getContext('2d', {alpha: false});
    inputImageContext.drawImage(inputImage, 0, 0);

    // canvas to show annotated output
    outputCanvas = document.getElementById('output');
    outputImageContext = outputCanvas.getContext('2d', {desynchronized: true, alpha: false});

    // text placeholders
    duration = document.getElementById("preprocess-duration");
    resolution = document.getElementById("resolution");

    // Process control button
    sendButton = document.getElementById("send");
    sendButton.addEventListener('click', loop);
...
console.log("analysis.js finished");
